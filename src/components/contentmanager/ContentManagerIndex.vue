<template>
    ...
    <div class="row">
    	<div class="col-12"><h4>Bio</h4></div>
    		...
    		<div class="CMFormWrap ps-2 pt-2 pe-2 pb-2 border-blue">
    			<form class="mt-2 mb-2" v-on:submit.prevent="getBio">
					<div class="row">
				        ...
				        <div class="col-auto req">
				            <Datepicker class="date-form-floating" id="dts" v-model="form.datetoset" week-start="0"  placeholder="Date" auto-apply :enable-time-picker="false"  :clearable="false"  :class="errors.datetoset ? 'error-input' : ''"></Datepicker>
    		...
    		<div class="CMFormWrap ps-2 pt-2 pe-2 pb-2 border-blue">
    			<form v-on:submit.prevent="setBio">
					<div class="row">
				        ...
				        <div class="col req">
				            <Datepicker class="date-form-floating" id="tts" v-model="form.timeset" placeholder="Time" time-picker :clearable="false" :class="errors.timeset ? 'error-input' : ''"></Datepicker> 
