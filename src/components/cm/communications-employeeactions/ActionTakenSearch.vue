    ...
    <div class="row shts">
        <div class="col pAgeEmail--title">
            <ul class="pAgeEmail--title__wrap">
                <li class="pAgeEmail--title__content"><h2 class="ps-1">Actions Taken</h2></li>
    ...
    export default{
        ...
        setup(props){
            ...
            const loadData = (content) =>{
                getUserActionsTakenSearch(content).then(() =>{
            ...
            const deleteSelected = async() =>{
               ...
               let x = 0; //trigger
                ...
                if (x > 0) {
                    ...
                    await getUserActionsTakenSearch(props.id).then(() => {
                        swal.fire({
                            toast: true,
                            position: 'top-end',
