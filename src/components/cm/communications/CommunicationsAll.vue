                    ...
                    <tbody>
                        ...
                        <template v-if="communications.length > 0">
                            <template v-for="communication in communications" :key="communication.id">                                
                                <tr @click="show(communication.id)">
                                    <td class="cmP">
                                        <span class="pin--comm" 
                                        :class="communication.pinned_at ? 'pinned': ''"
                        ...
                        <template v-if="noData">
                            <tr class="nodata">
                                <td colspan="8" class="text-center"> Communications Empty</td>
                            </tr>
                        </template>
                    </tbody>
                </table>  
...
<script>
    ...
    export default{
        ...
        setup(){
            ...
            const {communications, getAllCommunications, communicationLinks,  communicationMeta, pincommunication, bulkactions} = useCommunications()
